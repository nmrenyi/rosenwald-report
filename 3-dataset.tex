...
\label{sec:corpus}
In this paper, we focus on extracting doctor entries, with particular attention to female doctors, from 20 volumes published between 1887 and 1906. To narrow the scope of our analysis, we process only the sections titled \emph{Docteurs en médecine et en chirurgie} and \emph{Officiers de santé} for Paris and for the départements and colonies. We manually identified the relevant page ranges for each volume and extracted the corresponding pages as images.
